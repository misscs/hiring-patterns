...
* 12 years in tech
* Taking Portuguese classes + woodshop class
...
Note: When you are asked about yourself, respond by stating a moment or event to showcase what you have done
...
Note: What values do you want out of a place to work. If you can, prioritize them. What do you want to get out of the job? clear: room to grow, better process; for a new dev could be get a job on respectful teams

---

# Put time into research

Note: Helps you come prepared
...
Note:
Depends a lot what your first touch. If you are applying through an ad,
...
Reach out to employees on Twitter or at Meetups to help you learn more

---

# Detective work

Note: Questions to ask, signs to pay attention to, ideas for your values and tenets
...
Note: I'm a bit proponent of take home code challenges. while they can take longer they offer a better view of the candidate
...
- Documentation <!-- .element: class="fragment" data-fragment-index="4" -->
* Spacing <!-- .element: class="fragment" data-fragment-index="5" -->
* Indentation <!-- .element: class="fragment" data-fragment-index="6" -->
* Stale code (e.g. commented out) <!-- .element: class="fragment" data-fragment-index="7" -->

Note: Expand with quotes about software code rot and problems with deleting code
...
* Invest in aria-roles and patterns for common widgets
